...
void SuperDataBase::print_data_base() {
  main_belt_.print_whole_file_readable();
}
void SuperDataBase::print_sort_statistics() {
...
void SuperDataBase::print_compact_sort_statistics() {
  int rop = main_belt_.read_operation_count() +
            secondary_belt_.read_operation_count();
  int wop = main_belt_.write_operation_count() +
            secondary_belt_.write_operation_count();
...
void SuperDataBase::generate_random_data() {
  int record_num = 0;
